...
file_type_info = {
    "low_small_rest": ("low", "small"),
    "medium_small_rest": ("medium", "small"),
    "high_small_rest": ("high", "small"),
    "low_medium_rest": ("low", "medium"),
    "medium_medium_rest": ("medium", "medium"),
    "high_medium_rest": ("high", "medium"),
    "low_large_rest": ("low", "large"),
    "medium_large_rest": ("medium", "large"),
    "high_large_rest": ("high", "large"),
}
...
# Input directory
input_dir = 'data_v7/row_data'

# Output directory
output_dir = 'data_v7/data'
...
def clean_and_combine_files(output_dir, combined_file):
    ...
    with open(combined_file, 'w', newline='') as outfile:
        ...
        for file_name in os.listdir(output_dir):
            if file_name.endswith('.csv') and file_name != 'combined_data_rest.csv':
                ...
                with open(file_path, 'r') as infile:
                    ...
                    cleaned_rows = [[row[i] for i in range(len(row)) if i not in [2, 3]] for row in rows]
...
# Combine files
combined_file = '../../data_analysis/data/combined_data_rest.csv'
